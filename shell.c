...
void openHelp()
{
	puts("\n***WELCOME TO OUR SHELL HELP***"
		...
		"\n>rws -> removes all the white spaces such as 'space , /t , /n' from the text file and shows the result"
		"\n>suc -> shows the lines which are not commented (with # charachter)"
		"\n>mfw -> returns the string which is the most repeated"
		"\n>fw -> returns the beginning of every text file which is seprated by space from the rest of the line "
		"\n>nl -> shows the number of lines in each file"
		"\n>cd"
		"\n>ls"
		"\n>exit"
